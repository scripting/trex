...
XmlNode::Namespace(const v8::Arguments& args) {
  ...
  if (!ns) {
      ...
      v8::Handle<v8::Function> define_namespace =
          _libxmljs->namespace_constructor_template->GetFunction();
...
void
XmlNode::Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Handle<v8::Object> target) {
  v8::HandleScope scope;
