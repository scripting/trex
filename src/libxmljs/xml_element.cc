...
XmlElement::New(xmlNode* node)
{
    ...
    v8::Local<v8::Object> obj = _libxmljs->element_constructor_template->GetFunction()->NewInstance();
    element->Wrap(obj);
    return obj;
}
...
void
XmlElement::Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Persistent<v8::FunctionTemplate>& node_constructor_template, v8::Handle<v8::Object> target)
{
    v8::HandleScope scope;
