...
XmlDocument::New(xmlDoc* doc)
{
    ...
    v8::Local<v8::Object> obj = _libxmljs->document_constructor_template->GetFunction()->NewInstance();
...
void
XmlDocument::Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Handle<v8::Object> target)
{
    v8::HandleScope scope;
