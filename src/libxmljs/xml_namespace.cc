...
XmlNamespace::New(xmlNs* node)
{
    ...
    v8::Local<v8::Object> obj = _libxmljs->namespace_constructor_template->GetFunction()->NewInstance();
    ns->Wrap(obj);
    return obj;
}
...
void
XmlNamespace::Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Handle<v8::Object> target) {
  v8::HandleScope scope;
