...
XmlSaxParser::Callback(const char* what,
    ...
    v8::Persistent<v8::String> emit_symbol = v8::Persistent<v8::String>::New(v8::String::NewSymbol("emit")); //NODE_PSYMBOL("emit");
...
void
XmlSaxParser::Initialize(v8::Persistent<v8::FunctionTemplate>& sax_parser_template, v8::Persistent<v8::FunctionTemplate>& sax_push_parser_template, v8::Handle<v8::Object> target) {
  v8::HandleScope scope;
