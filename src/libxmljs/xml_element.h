...
public:
    ...
    static void Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Persistent<v8::FunctionTemplate>& node_constructor_template, v8::Handle<v8::Object> target);
