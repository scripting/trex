...
class XmlSaxParser : public node::ObjectWrap {
  ...
  static void
  Initialize(v8::Persistent<v8::FunctionTemplate>& sax_parser_template, v8::Persistent<v8::FunctionTemplate>& sax_push_parser_template, v8::Handle<v8::Object> target);
