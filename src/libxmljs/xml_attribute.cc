...
XmlAttribute::New(xmlNode* xml_obj, const xmlChar* name, const xmlChar* value)
{
    ...
    LibXMLJS* _libxmljs = (LibXMLJS*)v8::Isolate::GetCurrent()->GetData();
    v8::Local<v8::Object> obj = _libxmljs->attribute_constructor_template->GetFunction()->NewInstance();
    attribute->Wrap(obj);
    return obj;
}
...
void
XmlAttribute::Initialize(v8::Persistent<v8::FunctionTemplate>& constructor_template, v8::Persistent<v8::FunctionTemplate>& node_constructor_template, v8::Handle<v8::Object> target) {
  v8::HandleScope scope;
  v8::Local<v8::FunctionTemplate> t =
    v8::FunctionTemplate::New(XmlAttribute::New);
  constructor_template = v8::Persistent<v8::FunctionTemplate>::New(t);
  constructor_template->Inherit(node_constructor_template);
